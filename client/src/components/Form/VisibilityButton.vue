...
<template>
  <input type="checkbox" :id="id" name="show-checkbox" class="hidden peer" @change="updateValue" :checked="checked"/>
    <label :for="id" class="peer-checked:hidden inline-block cursor-pointer absolute right-3 top-1/2 -translate-y-1/2">
      <svg
        class="fill-slate-50 opacity-60 hover:opacity-90"
